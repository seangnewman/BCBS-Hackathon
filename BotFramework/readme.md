...
```shell
msbot clone services --name "BotFramework" --luisAuthoringKey "YOUR_AUTHORING_KEY" --folder "DeploymentScripts\msbotClone" --location "westus"
```
...
```shell
az bot publish --name "BotFramework" --resource-group "BotFramework"
```
