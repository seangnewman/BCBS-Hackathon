...
{
    public class BotFrameworkAccessors
    {
        public BotFrameworkAccessors(UserState userState, ConversationState conversationState)
        {
        ...
        public static string DialogStateName { get; } = $"{nameof(BotFrameworkAccessors)}.DialogState";
