...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.GetSetting("QnAAuthKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "Sorry,  could not understand the question, please rephrase your question", 0.5)))
        { }
    }
